 ...
 *   
 * @author Amelia Zafra
 * @author Revised by: Josi?oe Mari?oea Luna-Ariza
 */
...
public class NSGA2 extends PopulationAlgorithm
{
	...
	private void crowdingDistanceAssignment(List<IIndividual> front)
	{
		...
		PropertyIndividualsNSGA2 propFront = new PropertyIndividualsNSGA2();
		...
		for(int objective=0; objective<numberObjectives; objective++)
		{
			...
			for(int i=1; i<frontSize-1; i++)
			{
				...
				individualProperty.get(sortedFront.get(i)).setCuboPerimeter(propFront.getCubePerimeter() + auxDouble);
			}
		}
	}
